    ...
    <div className="sellersignuppcontainer">
      ...
      <div className="sellersignuppform-section">
        <div className="sellersignuppform-wrapper">
          ...
          <button className="sellersignupplogin-btn"  onClick={handleSignup}>
            Sign Up
            </button><br/>
            {successMessage && <p className="success-message">{successMessage}</p>}
            {errorMessage && <p className="error-message">{errorMessage}</p>}
          <Link to="/sellerlogin" style={{textDecoration:"none"}}> <button className='sellerform'> Log in </button></Link>
        </div>
      </div>
    </div>
  </div>
