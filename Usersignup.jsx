      ...
      <div className="usersignuppform-section">
        <div className="usersignuppform-wrapper">
          <div className="usersignupplogo-container">
            <a href="#" className="usersignupplogo-container">
          ...
          <button className="usersignupplogin-btn" onClick={handleSignup}>
              Sign Up
            </button> <br/>
            {successMessage && <p className="success-message">{successMessage}</p>}
            {errorMessage && <p className="error-message">{errorMessage}</p>}
          <Link to="/login" style={{textDecoration:"none"}}> <h4 className='sellerform'> Log in </h4></Link>
